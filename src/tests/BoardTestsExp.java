...
/**
 * BoardTestsExp
 * A series of tests to examine the test movement algorithm and test adjacency
 * list creation algorithm as it pertains to the initialization of the test game
 * board.
 * DATE: 3/26/2023
 * 
...
public class BoardTestsExp {
    ...
    /**
     * testAdjacency()
     * Test that the adjacency list feature is working properly with two different
     * scenarios.
     */
    @Test
    ...
    /**
     * testTargetsNormal()
     * Test that calcTargets is working properly with one scenario and no special
     * considerations.
     */
    @Test
    ...
    /**
     * testTargetsRoom()
     * Test that calcTargets is working properly with one scenario and room cells
     * present.
     */
    @Test
    ...
    /**
     * testTargetsOccupied()
     * Test that calcTargets is working properly with one scenario and occupied
     * cells present.
     */
    @Test
    ...
    /**
     * testTargetsMixed()
     * Test that calcTargets is working properly with one scenario and a mix of
     * occupied and room cells present.
     */
    @Test
