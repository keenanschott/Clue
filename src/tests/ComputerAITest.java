...
/**
 * ComputerAITest
 * A series of tests to examine the computer's AI processes as they relate to suggestion creation and movement.
 * DATE: 4/4/2023
...
public class ComputerAITest {
    ...
    public void testSelectTargets() {
        ...
        currentSeenCards.clear();
        // if room in list that has been seen, each target (room included) selected randomly
        ...
        board.calcTargets(board.getCell(testPlayer.getRow(),testPlayer.getColumn()), 3); // (2, 2) is the nearest reachable room, but other targets should be chosen randomly since it's been seen
