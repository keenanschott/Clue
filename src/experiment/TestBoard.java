...
/**
 * TestBoard
 * The test game board initialization; reads in the game setup and layout,
 * populates the game board, creates adjacency lists, etc. This class also
 * implements the movement algorithm.
 * DATE: 3/26/2023
 * 
